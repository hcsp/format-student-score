...
public class Main {
    ...
    public static String formatStudentScore(String student, int score) {
        ...
        if (score >= 90) {
            return String.format("学生%s的分数是%s，评级是A", student, score);
        } else if (score >= 60) {
            return String.format("学生%s的分数是%s，评级是B", student, score);
        } else {
            return String.format("学生%s的分数是%s，评级是C", student, score);
        }
    }
